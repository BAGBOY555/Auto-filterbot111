...
#Deploy 
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2FBAGBOY555%2FEvaMaria-1&envs=ADMINS%2CAPI_HASH%2CAPI_ID%2CAUTH_CHANNEL%2CAUTH_USERS%2CBOT_TOKEN%2CCHANNELS%2CCOLLECTION_NAME%2CDATABASE_NAME%2CDATABASE_URI%2CLOG_CHANNEL%2CPICS&optionalEnvs=AUTH_CHANNEL%2CAUTH_USERS%2CCHANNELS%2CCOLLECTION_NAME%2CDATABASE_NAME&ADMINSDesc=Username+or+ID+of+Admin.+Separate+multiple+Admins+by+space.&API_HASHDesc=Get+this+value+from+https%3A%2F%2Fmy.telegram.org&API_IDDesc=Get+this+value+from+https%3A%2F%2Fmy.telegram.org&AUTH_CHANNELDesc=ID+of+channel.Make+sure+bot+is+admin+in+this+channel.+Without+subscribing+this+channel+users+cannot+use+bot.&AUTH_USERSDesc=Username+or+ID+of+users+to+give+access+of+inline+search.+Separate+multiple+users+by+space.+Leave+it+empty+if+you+don%27t+want+to+restrict+bot+usage.&BOT_TOKENDesc=Your+bot+token.&CHANNELSDesc=Username+or+ID+of+channel+or+group.+Separate+multiple+IDs+by+space.&COLLECTION_NAMEDesc=Name+of+the+collections.+Defaults+to+Telegram_files.+If+you+are+using+the+same+database%2C+then+use+different+collection+name+for+each+bot&DATABASE_NAMEDesc=Name+of+the+database+in+mongoDB.&DATABASE_URIDesc=mongoDB+URI.+Get+this+value+from+https%3A%2F%2Fwww.mongodb.com.&LOG_CHANNELDesc=Bot+Logs%2CGive+a+channel+id+with+-100xxxxxxx&PICSDesc=Add+some+telegraph+link+of+pictures+.&ADMINSDefault=610120441&API_HASHDefault=2aa3fbf3db4fb92397352ccdd91067e1&API_IDDefault=1978658&BOT_TOKENDefault=5101976877%3AAAG-Q4p1rgYrveDrT1KhiKU_4V5jeG965IQ&DATABASE_NAMEDefault=auto-filter-bot-railway&DATABASE_URIDefault=mongodb%2Bsrv%3A%2F%2Faazim%3Aaazim%40cluster0.srxss.mongodb.net%2FmyFirstDatabase%3FretryWrites%3Dtrue%26w%3Dmajority&LOG_CHANNELDefault=-1001739489355&PICSDefault=https%3A%2F%2Ftelegra.ph%2Ffile%2Fcb5d1c4fced0125289b82.jpg&referralCode=GXC-6r)
